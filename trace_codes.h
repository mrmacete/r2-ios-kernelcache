...
#ifndef R_TRACE_CODES_H
#define R_TRACE_CODES_H

#define R_TRACE_CODES_LEN 3986

static const char * trace_codes[R_TRACE_CODES_LEN] = {
	...
	"0xff000104", "mach_notify_port_deleted",
	"0xff000114", "mach_notify_port_destroyed",
	"0xff000118", "mach_notify_no_senders",
	"0xff00011c", "mach_notify_send_once",
	"0xff000120", "mach_notify_dead_name",
	"0xff0001ec", "audit_triggers",
	"0xff000320", "host_info",
	"0xff000324", "host_kernel_version",
	"0xff000328", "host_page_size",
	"0xff00032c", "mach_memory_object_memory_entry",
	"0xff000330", "host_processor_info",
	"0xff000334", "host_get_io_master",
	"0xff000338", "host_get_clock_service",
	"0xff00033c", "kmod_get_info",
	"0xff000344", "host_virtual_physical_table_info",
	"0xff000348", "host_ipc_hash_info",
	"0xff00034c", "enable_bluebox",
	"0xff000350", "disable_bluebox",
	"0xff000354", "processor_set_default",
	"0xff000358", "processor_set_create",
	"0xff00035c", "mach_memory_object_memory_entry_64",
	"0xff000360", "host_statistics",
	"0xff000364", "host_request_notification",
	"0xff000368", "host_lockgroup_info",
	"0xff00036c", "host_statistics64",
	"0xff000370", "mach_zone_info",
	"0xff000640", "host_get_boot_info",
	"0xff000644", "host_reboot",
	"0xff000648", "host_priv_statistics",
	"0xff00064c", "host_default_memory_manager",
	"0xff000650", "vm_wire",
	"0xff000654", "thread_wire",
	"0xff000658", "vm_allocate_cpm",
	"0xff00065c", "host_processors",
	"0xff000660", "host_get_clock_control",
	"0xff000664", "kmod_create",
	"0xff000668", "kmod_destroy",
	"0xff00066c", "kmod_control",
	"0xff000670", "host_get_special_port",
	"0xff000674", "host_set_special_port",
	"0xff000678", "host_set_exception_ports",
	"0xff00067c", "host_get_exception_ports",
	"0xff000680", "host_swap_exception_ports",
	"0xff000684", "host_load_symbol_table",
	"0xff000688", "mach_vm_wire",
	"0xff00068c", "host_processor_sets",
	"0xff000690", "host_processor_set_priv",
	"0xff000694", "set_dp_control_port",
	"0xff000698", "get_dp_control_port",
	"0xff00069c", "host_set_UNDServer",
	"0xff0006a0", "host_get_UNDServer",
	"0xff0006a4", "kext_request",
	"0xff000960", "host_security_create_task_token",
	"0xff000964", "host_security_set_task_token",
	"0xff000f9c", "mach_gss_init_sec_context",
	"0xff000fa0", "clock_get_time",
	"0xff000fa4", "clock_get_attributes",
	"0xff000fa8", "clock_alarm",
	"0xff000fac", "mach_gss_accept_sec_context_v2",
	"0xff000fb0", "mach_gss_hold_cred",
	"0xff000fb4", "mach_gss_unhold_cred",
	"0xff000ffc", "lockd_request",
	"0xff001000", "lockd_ping",
	"0xff001004", "lockd_shutdown",
	"0xff0012c0", "clock_set_time",
	"0xff0012c4", "clock_set_attributes",
	"0xff001f40", "memory_object_get_attributes",
	"0xff001f44", "memory_object_change_attributes",
	"0xff001f48", "memory_object_synchronize_completed",
	"0xff001f4c", "memory_object_lock_request",
	"0xff001f50", "memory_object_destroy",
	"0xff001f54", "memory_object_upl_request",
	"0xff001f58", "memory_object_super_upl_request",
	"0xff001f5c", "memory_object_cluster_size",
	"0xff001f60", "memory_object_page_op",
	"0xff001f64", "memory_object_recover_named",
	"0xff001f68", "memory_object_release_name",
	"0xff001f6c", "memory_object_range_op",
	"0xff002008", "upl_abort",
	"0xff00200c", "upl_abort_range",
	"0xff002010", "upl_commit",
	"0xff002014", "upl_commit_range",
	"0xff002260", "memory_object_init",
	"0xff002264", "memory_object_terminate",
	"0xff002268", "memory_object_data_request",
	"0xff00226c", "memory_object_data_return",
	"0xff002270", "memory_object_data_initialize",
	"0xff002274", "memory_object_data_unlock",
	"0xff002278", "memory_object_synchronize",
	"0xff00227c", "memory_object_map",
	"0xff002280", "memory_object_last_unmap",
	"0xff002284", "memory_object_data_reclaim",
	"0xff002328", "memory_object_create",
	"0xff00238c", "default_pager_object_create",
	"0xff002390", "default_pager_info",
	"0xff002394", "default_pager_objects",
	"0xff002398", "default_pager_object_pages",
	"0xff0023a0", "default_pager_backing_store_create",
	"0xff0023a4", "default_pager_backing_store_delete",
	"0xff0023a8", "default_pager_backing_store_info",
	"0xff0023ac", "default_pager_add_file",
	"0xff0023b0", "default_pager_triggers",
	"0xff0023b4", "default_pager_info_64",
	"0xff0023dc", "default_pager_space_alert",
	"0xff002584", "exception_raise",
	"0xff002588", "exception_raise_state",
	"0xff00258c", "exception_raise_state_identity",
	"0xff002594", "mach_exception_raise",
	"0xff002598", "mach_exception_raise_state",
	"0xff00259c", "mach_exception_raise_state_identity",
	"0xff002bc0", "io_object_get_class",
	"0xff002bc4", "io_object_conforms_to",
	"0xff002bc8", "io_iterator_next",
	"0xff002bcc", "io_iterator_reset",
	"0xff002bd0", "io_service_get_matching_services",
	"0xff002bd4", "io_registry_entry_get_property",
	"0xff002bd8", "io_registry_create_iterator",
	"0xff002bdc", "io_registry_iterator_enter_entry",
	"0xff002be0", "io_registry_iterator_exit_entry",
	"0xff002be4", "io_registry_entry_from_path",
	"0xff002be8", "io_registry_entry_get_name",
	"0xff002bec", "io_registry_entry_get_properties",
	"0xff002bf0", "io_registry_entry_get_property_bytes",
	"0xff002bf4", "io_registry_entry_get_child_iterator",
	"0xff002bf8", "io_registry_entry_get_parent_iterator",
	"0xff002c00", "io_service_close",
	"0xff002c04", "io_connect_get_service",
	"0xff002c08", "io_connect_set_notification_port",
	"0xff002c0c", "io_connect_map_memory",
	"0xff002c10", "io_connect_add_client",
	"0xff002c14", "io_connect_set_properties",
	"0xff002c18", "io_connect_method_scalarI_scalarO",
	"0xff002c1c", "io_connect_method_scalarI_structureO",
	"0xff002c20", "io_connect_method_scalarI_structureI",
	"0xff002c24", "io_connect_method_structureI_structureO",
	"0xff002c28", "io_registry_entry_get_path",
	"0xff002c2c", "io_registry_get_root_entry",
	"0xff002c30", "io_registry_entry_set_properties",
	"0xff002c34", "io_registry_entry_in_plane",
	"0xff002c38", "io_object_get_retain_count",
	"0xff002c3c", "io_service_get_busy_state",
	"0xff002c40", "io_service_wait_quiet",
	"0xff002c44", "io_registry_entry_create_iterator",
	"0xff002c48", "io_iterator_is_valid",
	"0xff002c50", "io_catalog_send_data",
	"0xff002c54", "io_catalog_terminate",
	"0xff002c58", "io_catalog_get_data",
	"0xff002c5c", "io_catalog_get_gen_count",
	"0xff002c60", "io_catalog_module_loaded",
	"0xff002c64", "io_catalog_reset",
	"0xff002c68", "io_service_request_probe",
	"0xff002c6c", "io_registry_entry_get_name_in_plane",
	"0xff002c70", "io_service_match_property_table",
	"0xff002c74", "io_async_method_scalarI_scalarO",
	"0xff002c78", "io_async_method_scalarI_structureO",
	"0xff002c7c", "io_async_method_scalarI_structureI",
	"0xff002c80", "io_async_method_structureI_structureO",
	"0xff002c84", "io_service_add_notification",
	"0xff002c88", "io_service_add_interest_notification",
	"0xff002c8c", "io_service_acknowledge_notification",
	"0xff002c90", "io_connect_get_notification_semaphore",
	"0xff002c94", "io_connect_unmap_memory",
	"0xff002c98", "io_registry_entry_get_location_in_plane",
	"0xff002c9c", "io_registry_entry_get_property_recursively",
	"0xff002ca0", "io_service_get_state",
	"0xff002ca4", "io_service_get_matching_services_ool",
	"0xff002ca8", "io_service_match_property_table_ool",
	"0xff002cac", "io_service_add_notification_ool",
	"0xff002cb0", "io_object_get_superclass",
	"0xff002cb4", "io_object_get_bundle_identifier",
	"0xff002cb8", "io_service_open_extended",
	"0xff002cbc", "io_connect_map_memory_into_task",
	"0xff002cc0", "io_connect_unmap_memory_from_task",
	"0xff002cc4", "io_connect_method",
	"0xff002cc8", "io_connect_async_method",
	"0xff002ccc", "io_connect_set_notification_port_64",
	"0xff002cd0", "io_service_add_notification_64",
	"0xff002cd4", "io_service_add_interest_notification_64",
	"0xff002cd8", "io_service_add_notification_ool_64",
	"0xff002cdc", "io_registry_entry_get_registry_entry_id",
	"0xff002ee0", "processor_start",
	"0xff002ee4", "processor_exit",
	"0xff002ee8", "processor_info",
	"0xff002eec", "processor_control",
	"0xff002ef0", "processor_assign",
	"0xff002ef4", "processor_get_assignment",
	"0xff003200", "mach_port_names",
	"0xff003204", "mach_port_type",
	"0xff003208", "mach_port_rename",
	"0xff00320c", "mach_port_allocate_name",
	"0xff003210", "mach_port_allocate",
	"0xff003214", "mach_port_destroy",
	"0xff003218", "mach_port_deallocate",
	"0xff00321c", "mach_port_get_refs",
	"0xff003220", "mach_port_mod_refs",
	"0xff003228", "mach_port_set_mscount",
	"0xff00322c", "mach_port_get_set_status",
	"0xff003230", "mach_port_move_member",
	"0xff003234", "mach_port_request_notification",
	"0xff003238", "mach_port_insert_right",
	"0xff00323c", "mach_port_extract_right",
	"0xff003240", "mach_port_set_seqno",
	"0xff003244", "mach_port_get_attributes",
	"0xff003248", "mach_port_set_attributes",
	"0xff00324c", "mach_port_allocate_qos",
	"0xff003250", "mach_port_allocate_full",
	"0xff003254", "task_set_port_space",
	"0xff003258", "mach_port_get_srights",
	"0xff00325c", "mach_port_space_info",
	"0xff003260", "mach_port_dnrequest_info",
	"0xff003264", "mach_port_kernel_object",
	"0xff003268", "mach_port_insert_member",
	"0xff00326c", "mach_port_extract_member",
	"0xff003270", "mach_port_get_context",
	"0xff003274", "mach_port_set_context",
	"0xff003278", "mach_port_kobject",
	"0xff003520", "task_create",
	"0xff003524", "task_terminate",
	"0xff003528", "task_threads",
	"0xff00352c", "mach_ports_register",
	"0xff003530", "mach_ports_lookup",
	"0xff003534", "task_info",
	"0xff003538", "task_set_info",
	"0xff00353c", "task_suspend",
	"0xff003540", "task_resume",
	"0xff003544", "task_get_special_port",
	"0xff003548", "task_set_special_port",
	"0xff00354c", "thread_create",
	"0xff003550", "thread_create_running",
	"0xff003554", "task_set_exception_ports",
	"0xff003558", "task_get_exception_ports",
	"0xff00355c", "task_swap_exception_ports",
	"0xff003560", "lock_set_create",
	"0xff003564", "lock_set_destroy",
	"0xff003568", "semaphore_create",
	"0xff00356c", "semaphore_destroy",
	"0xff003570", "task_policy_set",
	"0xff003574", "task_policy_get",
	"0xff003578", "task_sample",
	"0xff00357c", "task_policy",
	"0xff003580", "task_set_emulation",
	"0xff003584", "task_get_emulation_vector",
	"0xff003588", "task_set_emulation_vector",
	"0xff00358c", "task_set_ras_pc",
	"0xff003590", "task_zone_info",
	"0xff003594", "task_assign",
	"0xff003598", "task_assign_default",
	"0xff00359c", "task_get_assignment",
	"0xff0035a0", "task_set_policy",
	"0xff0035a4", "task_get_state",
	"0xff0035a8", "task_set_state",
	"0xff003840", "thread_terminate",
	"0xff003844", "act_get_state",
	"0xff003848", "act_set_state",
	"0xff00384c", "thread_get_state",
	"0xff003850", "thread_set_state",
	"0xff003854", "thread_suspend",
	"0xff003858", "thread_resume",
	"0xff00385c", "thread_abort",
	"0xff003860", "thread_abort_safely",
	"0xff003864", "thread_depress_abort",
	"0xff003868", "thread_get_special_port",
	"0xff00386c", "thread_set_special_port",
	"0xff003870", "thread_info",
	"0xff003874", "thread_set_exception_ports",
	"0xff003878", "thread_get_exception_ports",
	"0xff00387c", "thread_swap_exception_ports",
	"0xff003880", "thread_policy",
	"0xff003884", "thread_policy_set",
	"0xff003888", "thread_policy_get",
	"0xff00388c", "thread_sample",
	"0xff003890", "etap_trace_thread",
	"0xff003894", "thread_assign",
	"0xff003898", "thread_assign_default",
	"0xff00389c", "thread_get_assignment",
	"0xff0038a0", "thread_set_policy",
	"0xff003b60", "vm_region",
	"0xff003b64", "vm_allocate",
	"0xff003b68", "vm_deallocate",
	"0xff003b6c", "vm_protect",
	"0xff003b70", "vm_inherit",
	"0xff003b74", "vm_read",
	"0xff003b78", "vm_read_list",
	"0xff003b7c", "vm_write",
	"0xff003b80", "vm_copy",
	"0xff003b84", "vm_read_overwrite",
	"0xff003b88", "vm_msync",
	"0xff003b8c", "vm_behavior_set",
	"0xff003b90", "vm_map",
	"0xff003b94", "vm_machine_attribute",
	"0xff003b98", "vm_remap",
	"0xff003b9c", "task_wire",
	"0xff003ba0", "mach_make_memory_entry",
	"0xff003ba4", "vm_map_page_query",
	"0xff003ba8", "mach_vm_region_info",
	"0xff003bac", "vm_mapped_pages_info",
	"0xff003bb4", "vm_region_recurse",
	"0xff003bb8", "vm_region_recurse_64",
	"0xff003bbc", "mach_vm_region_info_64",
	"0xff003bc0", "vm_region_64",
	"0xff003bc4", "mach_make_memory_entry_64",
	"0xff003bc8", "vm_map_64",
	"0xff003bcc", "vm_map_get_upl",
	"0xff003bd8", "vm_purgable_control",
	"0xff003e80", "processor_set_statistics",
	"0xff003e84", "processor_set_destroy",
	"0xff003e88", "processor_set_max_priority",
	"0xff003e8c", "processor_set_policy_enable",
	"0xff003e90", "processor_set_policy_disable",
	"0xff003e94", "processor_set_tasks",
	"0xff003e98", "processor_set_threads",
	"0xff003e9c", "processor_set_policy_control",
	"0xff003ea0", "processor_set_stack_usage",
	"0xff003ea4", "processor_set_info",
	"0xff004b00", "mach_vm_allocate",
	"0xff004b04", "mach_vm_deallocate",
	"0xff004b08", "mach_vm_protect",
	"0xff004b0c", "mach_vm_inherit",
	"0xff004b10", "mach_vm_read",
	"0xff004b14", "mach_vm_read_list",
	"0xff004b18", "mach_vm_write",
	"0xff004b1c", "mach_vm_copy",
	"0xff004b20", "mach_vm_read_overwrite",
	"0xff004b24", "mach_vm_msync",
	"0xff004b28", "mach_vm_behavior_set",
	"0xff004b2c", "mach_vm_map",
	"0xff004b30", "mach_vm_machine_attribute",
	"0xff004b34", "mach_vm_remap",
	"0xff004b38", "mach_vm_page_query",
	"0xff004b3c", "mach_vm_region_recurse",
	"0xff004b40", "mach_vm_region",
	"0xff004b44", "_mach_make_memory_entry",
	"0xff004b48", "mach_vm_purgable_control",
	"0xff004b4c", "mach_vm_page_info",
	"0xff004e20", "ledger_create",
	"0xff004e24", "ledger_terminate",
	"0xff004e28", "ledger_transfer",
	"0xff004e2c", "ledger_read",
	"0xff005140", "mach_get_task_label",
	"0xff005144", "mach_get_task_label_text",
	"0xff005148", "mach_get_label",
	"0xff00514c", "mach_get_label_text",
	"0xff005150", "mach_set_port_label",
	"0xff005154", "mac_check_service",
	"0xff005158", "mac_port_check_service_obj",
	"0xff00515c", "mac_port_check_access",
	"0xff005160", "mac_label_new",
	"0xff005164", "mac_request_label",
	"0xff005dc0", "UNDExecute_rpc",
	"0xff005dc4", "UNDDisplayNoticeFromBundle_rpc",
	"0xff005dc8", "UNDDisplayAlertFromBundle_rpc",
	"0xff005dcc", "UNDDisplayCustomFromBundle_rpc",
	"0xff005dd0", "UNDDisplayCustomFromDictionary_rpc",
	"0xff005dd4", "UNDCancelNotification_rpc",
	"0xff005dd8", "UNDDisplayNoticeSimple_rpc",
	"0xff005ddc", "UNDDisplayAlertSimple_rpc",
	"0xff0060e0", "UNDAlertCompletedWithResult_rpc",
	"0xff0060e4", "UNDNotificationCreated_rpc",
	"0xff01a5e0", "check_task_access",
	"0xff01a5e4", "find_code_signature",
	"0xff04b320", "kextd_ping",
	"0xff25a8a0", "lock_acquire",
	"0xff25a8a4", "lock_release",
	"0xff25a8a8", "lock_try",
	"0xff25a8ac", "lock_make_stable",
	"0xff25a8b0", "lock_handoff",
	"0xff25a8b4", "lock_handoff_accept",
	"0xff25abc0", "semaphore_signal",
	"0xff25abc4", "semaphore_signal_all",
	"0xff25abc8", "semaphore_wait",
	"0xff25abcc", "semaphore_signal_thread",
	"0xff25abd0", "semaphore_timedwait",
	"0xff25abd4", "semaphore_wait_signal",
	"0xff25abd8", "semaphore_timedwait_signal",
	"0xffbebdcc", "clock_alarm_reply",
};
